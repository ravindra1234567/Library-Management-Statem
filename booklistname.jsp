...
<%
		...
		{  
			...
			ResultSet rs=stmt.executeQuery("select distinct bookname from addbook  ");  
			out.println("<center>");
				...
				out.println("<select><option disabled selected>Book Name</option><option>"+result+"</option></select>");
				out.println("</center>");
